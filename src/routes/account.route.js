...
import { getAllTransactions, buyDataSubcription, buyAirtimeSubscription, payElectricityBills, buyCableSubscription, purchaseAirtime2Cash, purchaseBulkSms, resultCheck } from "../controllers/account.controller.js"
...
router.post("/result-checker", authenticateUser, resultCheck)
